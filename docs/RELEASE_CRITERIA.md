...
| Educação desigual                          | **Concluído no piso**        | Cinco percursos, avaliação desigual, matrícula, horas de estudo, cobrança e conclusão entram na agenda e no runner anual ([education](../src/core/life/education.ts), [runner](../tools/playtest/life-year.ts)).        | Manter todos os caminhos disponíveis aos seis arquétipos.                                               |
| Parceria, casamento, filhos e cuidado      | **Concluído no piso**        | Escolhas, casamento, filhos, separação, envelhecimento e cuidado diário são jogáveis, persistíveis e cobertos nas rotas “sim” e “não” ([family](../src/core/life/family.ts), [runner](../tools/playtest/life-year.ts)). | Manter os gates e expandir narrativas apenas no pós-1.0.                                                |
| Conjuntura econômica e social              | **Concluído no piso**        | Quatro eventos datados e atribuídos alteram renda, aluguel, dinheiro e disposição durante a trajetória ([conjuncture](../src/core/life/conjuncture.ts), [session](../src/core/session.ts)).                             | Manter fontes e efeitos legíveis.                                                                       |
| Trabalho e carreira                        | **Concluído no piso**        | Cada arquétipo tem jornada própria, salário mensal proporcional e duas transições condicionadas a trabalho e formação ([career](../src/core/life/career.ts), [calendar](../src/core/life/calendar.ts)).                 | Manter o balanceamento; conteúdo adicional é pós-1.0.                                                   |
| Mudança de moradia                         | **Concluído no piso**        | As cinco moradias podem ser escolhidas durante o ano; mudança cobra entrada e altera aluguel e deslocamento ([housing](../src/core/life/housing.ts), [UI](../src/main.ts)).                                             | Manter gates de economia e save.                                                                        |
| Calendário diário/mensal/anual             | **Concluído no piso**        | Agenda, recorrências idempotentes, balanço e epílogo atravessam 365 dias nos seis arquétipos ([calendar](../src/core/life/calendar.ts), [runner anual](../tools/playtest/life-year.ts)).                                | Manter artefato e ampliar seeds no gate final.                                                          |
| Economia doméstica integrada               | **Concluído no piso**        | Salário, aluguel, formação, mudança e cuidado afetam os mesmos centavos; extratos mensais registram trabalho, moradia e cuidado ([calendar](../src/core/life/calendar.ts)).                                             | Manter invariantes e revisar balanceamento no release candidate.                                        |
...
| Save e migrações                           | **Concluído no piso**        | Slots, checksum, migrações e round-trip preservam educação, família, carreira, moradia, recorrências e epílogo idempotente ([save](../src/core/save/save.ts), [testes](../src/core/save/save.test.ts)).                 | Manter compatibilidade com a versão anterior.                                                           |
...
O inventário registrou por que “campanha terminável” não significava “jogo da
vida terminado”. O tracer anual agora fecha o piso funcional num mesmo loop;
o release completo continua bloqueado pelos gates visuais, de experiência e
pela matriz ampliada de stress descrita abaixo.
...
runner produz o artefato para os seis arquétipos, com família, cuidado, duas
transições de carreira, mudança de moradia e balanço anual persistível. O
tracer está verde; o gate final ainda exige ampliar a matriz para 1.000 seeds
por arquétipo e adicionar a rota anual de browser.
